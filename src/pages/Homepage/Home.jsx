...
function Home() {
 ...
 const reels = [
    {
      ...
      embedUrl: 'https://www.instagram.com/reel/DQVtnhJjiAw/embed',
      videoThumbnail: '/image/Dream/video1.mp4',      
    },
    {
      id: 2,
      url: 'https://www.instagram.com/reel/DQbxeIXDjh5',
      embedUrl: 'https://www.instagram.com/reel/DQbxeIXDjh5/embed',
    ...
    },
    {
      ...
      embedUrl: 'https://www.instagram.com/reel/DO8qfc5ASFq/embed',
    ...
    },
    {
      ...
      embedUrl: 'https://www.instagram.com/reel/DNQZlo5hUBH/embed',
  ...
  const Set = {
    ...
    focusOnSelect: true,
    responsive: [
      { breakpoint: 1920, settings: { slidesToShow: 5, centerMode: true, centerPadding: '0px' } },
      { breakpoint: 1439, settings: { slidesToShow: 5, centerMode: true, centerPadding: '0px' } },
      { breakpoint: 1199, settings: { slidesToShow: 3, centerMode: true, centerPadding: '50px' } },
      { breakpoint: 991, settings: { slidesToShow: 1, centerMode: true, centerPadding: '80px', dots: true, autoplaySpeed: 3000 } },
      { breakpoint: 767, settings: { slidesToShow: 1, centerMode: true, centerPadding: '60px', dots: true, autoplaySpeed: 3000 } },
      { breakpoint: 575, settings: { slidesToShow: 1, centerMode: true, centerPadding: '40px', dots: true, autoplaySpeed: 3000 } },
      { breakpoint: 479, settings: { slidesToShow: 1, centerMode: true, centerPadding: '30px', dots: true, autoplaySpeed: 3000 } },
      { breakpoint: 413, settings: { slidesToShow: 1, centerMode: true, centerPadding: '25px', dots: true, autoplaySpeed: 3000 } },
      { breakpoint: 374, settings: { slidesToShow: 1, centerMode: true, centerPadding: '20px', dots: true, autoplaySpeed: 3000 } },
      { breakpoint: 360, settings: { slidesToShow: 1, centerMode: true, centerPadding: '15px', dots: true, autoplaySpeed: 3000 } }
    ]
  };
 ...
 <section>
      <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img className="d-block w-100 zoom" src="/image/homebanner/banner1.webp" alt="First slide" />
          </div>
          <div className="carousel-item">
            <img className="d-block w-100 zoom" src="/image/homebanner/P1095305.webp" alt="Second slide" />
          </div>
          <div className="carousel-item">
            <img className="d-block w-100 zoom" src="/image/banner.png" alt="Third slide" />
          </div>
        </div>
      </div>
    </section>

      <section className='FrontSecondSections services-Background'>
        <div className='DreamFrontSecondSection'>
          <div className="container">
            <div className='row'>
              <svg xmlns="http://www.w3.org/2000/svg" width="100" height="55" fill="currentColor" className="bi bi-camera-fill animate-on-scroll fade-in-scale" viewBox="0 0 16 16">
                <path d="M10.5 8.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0"/>
                <path d="M2 4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1.172a2 2 0 0 1-1.414-.586l-.828-.828A2 2 0 0 0 9.172 2H6.828a2 2 0 0 0-1.414.586l-.828.828A2 2 0 0 1 3.172 4zm.5 2a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1m9 2.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0"/>
              </svg>
              <h1 className='FrontHeadSection animate-on-scroll slide-up'>The best Photo Studio in Dehradun</h1>
              <div className='col-md-6 animate-on-scroll slide-left'>
                <p className='fst-italic'>Welcome to Dream Byte Studio, where we bring brands to life by creating compelling visuals.
                   As the creative heart of Dream Byte Solutions, we have enabled impactful showcasing and brand building for brands all over India and have become one of the most trusted Photo Studio in Dehradun and 
                   Uttarakhand.We have the Best photographers in Dehradun and our objective is to provide the 
                </p>
              </div>
              <div className='col-md-6 animate-on-scroll slide-right'>
                <p className='fst-italic'>highest quality output which will make your memories look even more beautiful through attractive cinematics, candid shots and videos. We are a team of young and experienced professionals who have worked with top brands in India. We provide a wide
                     range of services, whether it is a corporate event shoot, product shoot, wedding photography and videography, documentary, etc.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="FrontSecondSection services-sections py-5">
        <h1 className="FrontHeadSection animate-on-scroll slide-up">Services we offer</h1>
        <div className="DreamFrontSecondSection">
          <p className="fst-italic animate-on-scroll fade-in">
        ...
        <div className="DreamCards services-section">
          <div className="container">
            <div className="row g-4">
              {services.map((service, i) => (
                <div className={`col-md-4 animate-on-scroll card-float`} key={i} style={{animationDelay: `${i * 0.1}s`}}>
          ...
          <button className="DreamBtn mt-5 animate-on-scroll bounce-in">
      ...
      <section className='FrontSecondSections services-sec'>
        <div className='DreamFrontSecondSection'>
          <div className="container">
            <div className='row'>
              <svg xmlns="http://www.w3.org/2000/svg" width="100" height="55" fill="currentColor" className="bi bi-camera-fill animate-on-scroll rotate-in" viewBox="0 0 16 16">
                <path d="M10.5 8.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0"/>
                <path d="M2 4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1.172a2 2 0 0 1-1.414-.586l-.828-.828A2 2 0 0 0 9.172 2H6.828a2 2 0 0 0-1.414.586l-.828.828A2 2 0 0 1 3.172 4zm.5 2a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1m9 2.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0"/>
              </svg>
              <h1 className='FrontHeadSection animate-on-scroll slide-down'>What makes us the Best Photographers in Dehradun?</h1>
              <div className='col-md-6 animate-on-scroll slide-left'>
                <p className='fst-italic'>At Dream Byte Studio, we combine creativity, technology, storytelling, and our expertise to deliver your story to the world. We believe every brand has a purpose behind its establishment. As a finest Photo Studio in Dehradun 
                  we not only capture and shoot your videos and photos, but we give them life so that your memories never fade,and </p>
              </div>
              <div className='col-md-6 animate-on-scroll slide-right'>
                <p className='fst-italic'>your brand shines and represents the vision of your business. Over the years, we have completed numerous quality projects and have established ourselves as the Best photographer in Dehradun. 
       ...
       <section className=''>
        <div className='TopBanner'>
          <img src="/image/banner/STUDIOBANNER.webp" alt="img" />
        </div>
      </section>
      ...
      <section className='FrontSecondSection services-sections'>
        <div className=''>
          <div className="container-fluid">
            <div className='row'>
              <h1 className='FrontHeadSection animate-on-scroll slide-up'>Why Choose Us?</h1>
              <div className="DreamPadding">
                <div className="row">
                  <div className="col-sm-4 mb-3 mb-sm-0 animate-on-scroll card-flip" style={{animationDelay: '0.1s'}}>
                    <div className='DreamCards'>
                      <div className="card card4">
                        <div className="card-body">
                          ...
                          <h5 className="card-title">Creative Team</h5>
                          <p>Every member has a keen eye and carries the Foto Zone aesthetic, and hence no moment goes amiss</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="col-sm-4 mb-3 mb-sm-0 animate-on-scroll card-flip" style={{animationDelay: '0.2s'}}>
                    <div className='DreamCards'>
                      <div className="card card4">
                        <div className="card-body">
                          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="60" fill="currentColor" className="bi bi-gem" viewBox="0 0 16 16">
                  ...
                  <div className="col-sm-4 mb-3 mb-sm-0 animate-on-scroll card-flip" style={{animationDelay: '0.3s'}}>
                    <div className='DreamCards'>
                      <div className="card card4">
                        <div className="card-body">
                          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="60" fill="currentColor" className="bi bi-yelp" viewBox="0 0 16 16">
                          ...
                          <h5 className="card-title">Hand Holding</h5>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-2'>
              <img src="/image/jaivik webp/1.webp" alt="image" className='ImageHomepage'/>
            </div>
            <div className='col-md-2'> <img src="/image/jaivik webp/1.webp" alt="image" className='ImageHomepage'/></div>
            <div className='col-md-2'> <img src="/image/jaivik webp/1.webp" alt="image" className='ImageHomepage'/></div>
            <div className='col-md-2'> <img src="/image/jaivik webp/1.webp" alt="image" className='ImageHomepage'/></div>
            <div className='col-md-2'>  <img src="/image/jaivik webp/1.webp" alt="image" className='ImageHomepage'/></div>
            <div className='col-md-2'> <img src="/image/jaivik webp/1.webp" alt="image" className='ImageHomepage'/></div>
      ...
      <section className='FrontSecondSections' id="aboutus">
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-md-7 animate-on-scroll slide-left'>
            ...
            <div className='col-md-5 animate-on-scroll slide-right'>
      ...
      <section className='FrontSecondSection services-sections'>
        <h1 className='FrontHeadSection animate-on-scroll slide-up'>Portfolio</h1>
        <div className='container-fluid'>
          <div className='DreamPad'>
            <div className="slider-container animate-on-scroll zoom-in">
              <div className="container-fluid">
      ...
      <section id="accordian" className="bsb-accordion-6 py-3 py-md-5 py-xl-8 FrontSecondSections services-sec">
        <h1 className="FrontHeadSection text-center mb-5 animate-on-scroll slide-up">
          ...
          <div className="row">
            <div className="col-10 col-md-8 mx-auto">
              <div className="accordion" id="accordionExample">
                <div className="accordion-item accSpace animate-on-scroll fade-in" style={{animationDelay: '0.1s'}}>
                ...
                <div className="accordion-item accSpace animate-on-scroll fade-in" style={{animationDelay: '0.2s'}}>
                  <h4 className="accordion-header">
                    <button
                      className="accordion-button collapsed FAQ"
                      type="button"
                ...
                <div className="accordion-item accSpace animate-on-scroll fade-in" style={{animationDelay: '0.3s'}}>
                  <h4 className="accordion-header">
                    <button
                      className="accordion-button collapsed FAQ"
                      type="button"
                ...
                <div className="accordion-item accSpace animate-on-scroll fade-in" style={{animationDelay: '0.4s'}}>
                  <h4 className="accordion-header">
                    <button
                      className="accordion-button collapsed FAQ"
                      type="button"
                ...
                <div className="accordion-item accSpace animate-on-scroll fade-in" style={{animationDelay: '0.5s'}}>
                  <h4 className="accordion-header">
                    <button
                      className="accordion-button collapsed FAQ"
                      type="button"
      ...
      <div className="container-fluid">
        <div className="text-center mb-5">
          <h2 className="FrontHeadSection display-4 mb-2">Instagram Reels</h2>
          <p className='DreamWrapperParagarph'>Click any reel to watch</p>
        </div>
        
        <div className="row g-4">
          {reels.map((reel, index) => (
            <div key={reel.id} className="col-lg-3 col-md-6 col-6 col-sm-6">
              <div 
              ...
              >
                ...
                <div style={{ position: 'relative', paddingBottom: '177.78%', background: '#000' }}>
                  ...
                  {/* Play Button with unique designs */}
                  <div 
                    style={{
                      position: 'absolute',
                      top: '50%',
                  ...
                  <div style={{
                    ...
                    <h5 className="text-white fw-bold mb-0">{reel.title}</h5>
                  </div>
    ...
    <div className="reel-modal">
      ...
      ></div>
      <video
        src={selectedReel.videoThumbnail}
        autoPlay
        loop
        playsInline
        muted={false}
      ...
      <section className='FrontSecondSection services-sections'>
        <h1 className='FrontHeadSection animate-on-scroll slide-up'>Testimonials</h1>
        <div className='container-fluid'>
          <div className='animate-on-scroll fade-in'>
            <iframe src='https://widgets.sociablekit.com/google-reviews/iframe/25609973' frameborder='0' width='100%' height='1000'></iframe>
          </div>
        </div>
      </section>
