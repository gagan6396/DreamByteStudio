            ...
            <ul className="nav-menu desktop-menu">
              ...
              <li className="nav-item dropdown-wrapper">
                ...
                <ul className="dropdown-content">
                  <li><Link to="/ServiceAreaDehradun">Dehradun</Link></li>
                  <li><Link to="/ServiceAreaDelhi">Delhi</Link></li>
                  <li><Link to="/ServiceAreaRishikesh">Rishikesh</Link></li>
                  <li><Link to="/ServiceAreaNodia">Noida</Link></li>
                  <li><Link to="/ServiceAreaGurgaon">Gurgaon</Link></li>
                </ul>
              </li>
              <li className="nav-item">
                <NavLink
